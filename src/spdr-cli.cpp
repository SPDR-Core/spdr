...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Spidercore RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  spdr-cli [options] <command> [params]  " + _("Send command to Spidercore") + "\n" +
                        "  spdr-cli [options] help                " + _("List commands") + "\n" +
                        "  spdr-cli [options] help <command>      " + _("Get help for a command") + "\n";
