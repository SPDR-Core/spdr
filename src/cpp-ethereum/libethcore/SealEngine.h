...
////////////////////////////////////////////////////////////// // spdr
	void setSpiderSchedule(EVMSchedule _spdrSchedule) const { spdrSchedule = _spdrSchedule; }

	EVMSchedule& getSpiderSchedule() const { return spdrSchedule; }
...
private:
	...
	mutable EVMSchedule spdrSchedule; // spdr
