...
// Reject all splited stake blocks under 200 SPDR
static const int REJECT_INVALID_SPLIT_BLOCK_HEIGHT = 90000000;
...
//!<DuzyDoc>: Stake - singleton class encapsulating PoS feature for Spider.
