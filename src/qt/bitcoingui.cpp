...

{
    ...
    //fill in frameSocMedia
    {
        ...
        connect(pushButtonDiscord, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://discord.gg/vqzqWJg"));});
        ...
        pushButtonHelp->setToolTip(tr("Go to")+" WebSite");
        connect(pushButtonHelp, &QPushButton::clicked,
                this, [](){QDesktopServices::openUrl(QUrl("https://spidervps.net/"));});
...
void BitcoinGUI::updateNetworkState() {
    ...
    case 1: case 2: case 3: icon = ":/icons/connect_2"; break;
    case 4: case 5: case 6: icon = ":/icons/connect_3"; break;
    case 7: case 8: case 9: icon = ":/icons/connect_4"; break;
