...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SpiderTestFramework
    pass

class ExampleTest(SpiderTestFramework):
    # Each functional test is a subclass of the SpiderTestFramework class.
    ...
    def custom_method(self):
        ...
        SpiderTestFramework class so other tests can use it."""
