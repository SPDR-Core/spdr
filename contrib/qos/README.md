...
This means one can have an always-on spdrd instance running, and another local spdrd/spdr-qt instance which connects to this node and receives blocks from it.
